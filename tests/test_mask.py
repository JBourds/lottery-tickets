...
root = "/users/j/b/jbourde2/lottery-tickets/experiments/lenet_mnist_0_seed_3_experiments_1_batches_0.05_default_sparsity_lm_pruning_20241015-053957/models/model0"
first = history.TrialData.load_from(os.path.join(root, "trial0", "trial_data.pkl"))
last = history.TrialData.load_from(os.path.join(root, "trial14", "trial_data.pkl"))
