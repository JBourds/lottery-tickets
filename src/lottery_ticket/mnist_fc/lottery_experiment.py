...
import functools
from src.lottery_ticket.datasets import dataset_mnist
from src.lottery_ticket.foundations import experiment
from src.lottery_ticket.foundations import model_fc
from src.lottery_ticket.foundations import paths
from src.lottery_ticket.foundations import pruning
from src.lottery_ticket.foundations import save_restore
from src.lottery_ticket.foundations import trainer
from src.lottery_ticket.mnist_fc import constants
...
def train(output_dir,
  ...
  def train_model(level, dataset, model):
    params = {
        'test_interval': 100,
        'save_summaries': True,
        'save_network': True,
