...
def plot_aggregated_summary_ci(
    ...
    Args:
        x (np.ndarray[float]): X values to plot.
        y_mean (np.ndarray[float]): Y values to use for the mean.
        y_std (np.ndarray[float]): Y values to use for the standard deviation at each point.
